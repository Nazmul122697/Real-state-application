...
<head>
    ...
    <link rel="icon" href="{{ asset('uploads/image/bti-logo.png') }}" type="image/x-icon">
...
<body class="hold-transition login-page">
    <div id="section_login" style="background: url({{ asset('backend/images/logIn-bg.jpeg') }}) center center no-repeat; background-size: cover;">
        <div class="login-box">
            <!-- /.login-logo -->
            <div class="login-box-body">
                <div class="login-logo mb-0 text-center">
                    <img style="width: 80px" src="{{ asset('backend/images/logo.jpg') }}" alt="">
