<table id="datatable" class="table table-bordered table-striped table-hover">
	<thead>
		<tr>
			...
			<th style=" min-width: 70px" class="text-center">Lead 2 K1</th>
			<th style=" min-width: 80px" class="texot-center">k12priority</th>
			<th style=" min-width: 100px" class="text-center">priority2sold</th>
			<th style=" min-width: 100px" class="text-center">k12sold</th>
