...
<form id="frmLead" action="{{ !isset($lead_data)?route('lead.store') : route('lead.update',$lead_data->lead_pk_no) }}" method="{{ !isset($lead_data)?'post' : 'patch' }}">
	<div class="box box-success">
		...
		<div class="box-body">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						<label for="txt_lead_date">Date </label>
						<input type="text" class="form-control datepicker" id="txt_lead_date" name="txt_lead_date" value="<?php echo date('d-m-Y'); ?>" title="" readonly="" placeholder="Entry Date"/>
					</div>
				</div>
				...
				<div class="col-md-12">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<input type="text" class="form-control required capitalize-text" id="customer_first_name" name="customer_first_name" value="" title="" placeholder="First Name"/>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<input type="text" class="form-control required capitalize-text" id="customer_last_name" name="customer_last_name" value="" title="" placeholder="Last Name"/>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-xs-8">
									<input type="number" class="form-control number-only" id="customer_phone1" name="customer_phone1" maxlength="10" placeholder="Phone Number 1"/>
								</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-xs-8">
									<input type="number" class="form-control number-only" id="customer_phone2" name="customer_phone2" maxlength="10" placeholder="Phone Number 2"/>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="email" class="form-control required email-only" id="customer_email" name="customer_email" value="" title="Customer Email" placeholder="@mail"/>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<select class="form-control select2" name="cmb_ocupation" style="width: 100%;" aria-hidden="true">
							<option selected="selected" value="0">Please Select Occupation</option>
							@if(!empty($ocupations))
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<select class="form-control required" id="cmb_area" name="cmb_area" style="width: 100%;" aria-hidden="true">
							<option selected="selected" value="">Please Select Area</option>
						</select>
					</div>
				</div>
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<select class="form-control required" id="cmb_project_name" name="cmb_project_name" style="width: 100%;" aria-hidden="true">
							<option selected="selected" value="">Please Select Project Name</option>
						</select>
					</div>
				</div>
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<select class="form-control required" id="cmb_size" name="cmb_size" style="width: 100%;" aria-hidden="true">
							<option selected="selected" value="">Please Select Size</option>
						</select>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="txt_source_title" name="txt_source_title"
						value="{{ Session::get('user.ses_role_name') }}" title="Source Title"
						readonly="readonly" placeholder="Source Title"/>
						<input type="hidden" name="hdn_source_role" value="{{ Session::get('user.ses_user_id') }}" readonly="readonly" />
					</div>
				</div>
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="email" class="form-control" id="txt_source_name" name="txt_source_name"
						value="{{ Session::get('user.ses_full_name') }}" title="Source Name"
						readonly="readonly" placeholder="Source Name"/>
						<input type="hidden" name="hdn_source_id" value="{{ Session::get('user.ses_user_id') }}" readonly="readonly" />
					</div>
				</div>
			</div>
		</div>
	...
	<div class="box" style="border-color:#ff851b;">
		...
		<div class="box-body">
			<div class="col-md-3">
				<div class="form-group">
					<label for="txt_emp_id">Emp ID </label>
					<input type="text" class="form-control" id="txt_emp_id" name="txt_emp_id" value="" title="Emp ID" placeholder="Emp ID"/>
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
					<label for="txt_emp_name">Name </label>
					<input type="text" class="form-control" id="txt_emp_name" name="txt_emp_name" value="" title="Name" placeholder="Name"/>
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
					<label for="txt_emp_position">Position </label>
					<input type="text" class="form-control" id="txt_emp_position" name="txt_emp_position" value="" title="Position" placeholder="Position"/>
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
					<label for="txt_contract_no">Contact Number :</label>
					<input type="text" class="form-control" id="txt_contract_no" name="txt_contract_no" value="" title="Contact Number" placeholder="Contact Number"/>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="box box-info">
		<div class="box-header with-border">
			<label class="" style="cursor: pointer;">
				<div class="iradio_flat-green" aria-checked="false" aria-disabled="false" style="position: relative; margin-right:10px; margin-bottom:6px;">
					<input type="radio" id="chk_hotline" value="" name="chk_hotline" class="flat-red" style="position: absolute; opacity: 0;">
					<ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
				</div>
				<span style="font-size:18px; margin-top:-5px;">Hotline</span>
			</label>
		</div>
		<div class="box-body">
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-group">
						<label style="cursor:pointer;">
							<div class="iradio_flat-green" aria-checked="false" aria-disabled="false" style="position: relative; margin-right:10px; margin-bottom:6px;">
								<input type="radio" id="hotline_element" value="{{ $key }}" name="hotline_element" class="flat-red"  style="position: absolute; opacity: 0;">
								<ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
							</div>
							<span style="font-size:14px;">&nbsp;&nbsp; {{ $hline }}</span>
						</label>
					</div>
				</div>
				@endforeach
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<select class="form-control select2" name="cmb_press_add" style="width: 100%;" aria-hidden="true">
						<option selected="selected" value="0">Please Select Press Ad.</option>
						@if(!empty($press_adds))
						@foreach ($press_adds as $key => $press_add)
						<option value="{{ $key }}">{{ $press_add }}</option>
						@endforeach
						@endif
					</select>
				</div>
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<select class="form-control select2" name="cmb_billboard" style="width: 100%;" aria-hidden="true">
						<option selected="selected" value="0">Please Select Billboard</option>
						@if(!empty($billboards))
						@foreach ($billboards as $key => $billboard)
						<option value="{{ $key }}">{{ $billboard }}</option>
						@endforeach
						@endif
					</select>
				</div>
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<select class="form-control select2" name="cmb_project_board" style="width: 100%;" aria-hidden="true">
						...
						<option value="{{ $key }}">{{ $project_board }}</option>
						@endforeach
						@endif
					</select>
				</div>
			...
			<div class="col-md-4">
				<div class="form-group">
					<label>Flyer </label>
					<select class="form-control select2" name="cmb_flyer" style="width: 100%;" aria-hidden="true">
						<option selected="selected" value="0">Select Flyer</option>
						@if(!empty($flyers))
						@foreach ($flyers as $key => $flyer)
						<option value="{{ $key }}">{{ $flyer }}</option>
						@endforeach
						@endif
					</select>
				</div>
			...
			<div class="col-md-4">
				<div class="form-group">
					<label>FNF </label>
					<select class="form-control select2" name="cmb_fnf" style="width: 100%;" aria-hidden="true">
						<option selected="selected" value="0">Existing Customer Name</option>
						@if(!empty($fnfs))
						@foreach ($fnfs as $key => $fnf)
						<option value="{{ $key }}">{{ $fnf }}</option>
						@endforeach
						@endif
					</select>
				</div>
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="txt_other" name="txt_other" value="" title="Others" placeholder="Others"/>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="txt_sale_event" name="txt_sale_event" value="" title="Sales Event" placeholder="Sales Event"/>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="txt_cust_engagment" name="txt_cust_engagment" value="" title="Customer Engagement" placeholder="Customer Engagement"/>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="txt_fair" name="txt_fair" value="" title="Fair" placeholder="Input Fair Name"/>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="box" style="border-color:#444444;">
		...
		<div id="more_details" class="box-body hidden">
			<div class="row" id="appendPlace">
				...
				<input type="hidden" id="TotalRow" name="TotalRow" value="3">
			</div>
		</div>
