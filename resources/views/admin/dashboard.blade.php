		...
		<div class="col-lg-3 col-xs-6">
			...
			<div class="small-box bg-grey">
				<div class="inner">
					...
					<p>{{ isset($upcomming[0]->total_lead)?$upcomming[0]->total_lead:0 }}</p>
				</div>
				<div class="icon">
					<i class="ion ion-power"></i>
				</div>
				...
				<a href="#" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
				@else
				<a href="{{ route('lead_list', 8) }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
				@endif
			</div>
		</div>
		<div class="col-lg-3 col-xs-6">
			...
			<div class="small-box bg-yellow">
				<div class="inner">
					...
					<p>{{ isset($followup[0]->total_lead)?$followup[0]->total_lead:0 }}</p>
				</div>
				<div class="icon">
					<i class="ion ion-arrow-graph-up-right"></i>
				</div>
				...
				<a href="#" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
				@else
				<a href="{{ route('lead_list', 10) }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
				@endif
			</div>
		</div>
		...
		<div class="col-lg-3 col-xs-6">
			...
			<div class="small-box bg-green">
				<div class="inner">
					...
					<p>{{ isset($call_again[0]->total_lead)?$call_again[0]->total_lead:0 }}</p>
				</div>
				<div class="icon">
					<i class="ion ion-power"></i>
				</div>
				...
				<a href="#" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
				@else
				<a href="{{ route('lead_list', 11) }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
				@endif
			</div>
		</div>
		...
		<div class="col-lg-3 col-xs-6">
			...
			<div class="small-box bg-red">
				<div class="inner">
					...
					<p>{{ isset($unadrressed[0]->total_lead)?$unadrressed[0]->total_lead:0 }}</p>
				</div>
				<div class="icon">
					<i class="ion ion-power"></i>
				</div>
				...
				<a href="#" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
				@else
				<a href="{{ route('lead_list', 12) }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
				@endif
			</div>
		</div>
