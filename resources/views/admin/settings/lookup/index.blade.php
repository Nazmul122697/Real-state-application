				...
				<div class="box-header with-border">
					<div class="col-md-6">
						<div class="form-group">
							...
							<select name="cmbLookupTypeMst" id="cmbLookupTypeMst" class="form-control select2 select2-hidden-accessible" style="width: 100%;" aria-hidden="true">
...
<script>
    ...
    $(document).ready(function () {
        $('#cmbLookupTypeMst').change(function () {
            $('.data-table').DataTable().columns(2).search($('#cmbLookupTypeMst').val()).draw();
        })
    });
</script>
@endpush
