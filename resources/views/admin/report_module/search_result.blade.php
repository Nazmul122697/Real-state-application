...
<div class="box box-info">
	<div class="box-header with-border">
		...
		@if($is_super_admin == 1&& Auth::id()!=874)
			...
			<tbody>
				...
				<tr>
					...
					<td class="text-center">
                        ...
                        @if (Auth::id()!=874)
						<a class="btn bg-info btn-xs" target="_blank" title="Lead Download" data-id="{{ $row->lead_pk_no }}" href="{{ route('lead_download',$row->lead_pk_no) }}"><i class="fa fa-download" aria-hidden="true"></i></a>
                        @endif
					</td>
				</tr>
				@php $i++; @endphp
