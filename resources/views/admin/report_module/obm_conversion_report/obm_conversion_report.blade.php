...
@section('content')
    ...
    <section class="content-header">
        <h1>OBM Conversion Report Part A</h1>

        <ol class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Report Module</a></li>
            <li class="active">OBM Conversion Report Part A</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12" id="search_result_con">
                @include("admin.report_module.obm_conversion_report.obm_conversion_report_result")
            </div>
        </div>
    </section>
    <!-- /.content -->
            ...
            $(document).on("click", "#btnSearchReport", function(e) {
                ...
                if (report_type == "") {
                    ...
                    $.ajax({
                        ...
                        url: 'obm_conversion_report_result',
                        type: 'post',
                        beforeSend: function() {
                            $.blockUI({
