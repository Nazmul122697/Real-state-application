...
@section('content')
    ...
    <section class="content-header">
        <h1>K Classification</h1>

        <ol class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Report Module</a></li>
            <li class="active">K Classification</li>
        </ol>
    </section>
                            ...
                            <div class="form-row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="cluster_head">Select Type </label>
                                        <select name="lead_type" id="lead_type" class="form-control select2">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="cluster_head">Project Cateogory</label>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="t_year" value="{{ date('Y') }}">
                                    </div>
                                </div>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12" id="search_result_con">
                @include("admin.report_module.k_classification.k_classification_result")
            </div>
        </div>
    </section>
    <!-- /.content -->
...
@push('js_custom')
    <script>
        $(document).on("change", "#lead_type", function(e) {
            e.preventDefault();
            $.ajax({
                data: {
                    type: $(this).val()
                },
                url: 'get_type_wise_catgeory',
                type: 'post',
                beforeSend: function() {
                    $.blockUI({
