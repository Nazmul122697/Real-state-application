                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="txt_customer_name"
                                            name="txt_customer_name" value="" title=""
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="txt_mobile_no" name="txt_mobile_no"
                                            value="" title="" placeholder="Enter Mobile No" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="txt_email" name="txt_email"
                                            value="" title="" placeholder="Enter @mail" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 select2-hidden-accessible" style="width: 100%;"
                                            aria-hidden="true" name="cmbOccupation">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 select2-hidden-accessible" style="width: 100%;"
                                            aria-hidden="true" name="cmbOrganization">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="cmbCategory" style="width: 100%;"
                                            aria-hidden="true">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="cmbArea" style="width: 100%;"
                                            aria-hidden="true">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="cmbProjectName" style="width: 100%;"
                                            aria-hidden="true">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="cmbSize" style="width: 100%;"
                                            aria-hidden="true">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-daterange input-group" id="datepicker">
                                            <input type="text" class="input-sm form-control datepicker"
                                                name="txt_entry_date" readonly="readonly" style="padding: 17px 0px;">
                                            <span class="input-group-addon">To</span>
                                            <input type="text" class="input-sm form-control datepicker"
                                                name="txt_entry_date_to" readonly="readonly" style="padding: 17px 0px;">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="cust_date_birth">Current Date Range :</label>
                                        <div class="input-daterange input-group" id="datepicker">
                                            <input type="text" class="input-sm form-control datepicker"
                                                name="txt_current_date" readonly="readonly" style="padding: 17px 0px;">
                                            <span class="input-group-addon">To</span>
                                            <input type="text" class="input-sm form-control datepicker"
                                                name="txt_current_date_to" readonly="readonly"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 select2-hidden-accessible"
                                            style="width: 100%;" aria-hidden="true" name="cmb_stage">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="">SBU :</label>
                                        <select class="form-control select2" name="lead_type[]" style="width: 100%;"
                                            aria-hidden="true" multiple="multiple">
                                            <option value="">Please Select SBU</option>
                                            @if (!empty($lead_type))
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <div class="input-daterange input-group" id="datepicker">
                                        <input type="text" class="input-sm form-control datepicker"
                                            name="txt_cus_dob_from" readonly="readonly" style="padding: 17px 0px;">
                                        <span class="input-group-addon">To</span>
                                        <input type="text" class="input-sm form-control datepicker"
                                            name="txt_cus_dob_to" readonly="readonly" style="padding: 17px 0px;">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-daterange input-group" id="datepicker">
                                        <input type="text" class="input-sm form-control datepicker"
                                            name="txt_mar_date_from" readonly="readonly" style="padding: 17px 0px;">
                                        <span class="input-group-addon">To</span>
                                        <input type="text" class="input-sm form-control datepicker"
                                            name="txt_mar_date_to" readonly="readonly" style="padding: 17px 0px;">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-daterange input-group" id="datepicker">
                                        <input type="text" class="input-sm form-control datepicker"
                                            name="txt_cus_wife_dob_from" readonly="readonly" style="padding: 17px 0px;">
                                        <span class="input-group-addon">To</span>
                                        <input type="text" class="input-sm form-control datepicker"
                                            name="txt_cus_wife_dob_to" readonly="readonly" style="padding: 17px 0px;">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-daterange input-group" id="datepicker">
                                        <input type="text" class="input-sm form-control datepicker"
                                            name="txt_cus_child_dob_from" readonly="readonly" style="padding: 17px 0px;">
                                        <span class="input-group-addon">To</span>
                                        <input type="text" class="input-sm form-control datepicker"
                                            name="txt_cus_child_dob_to" readonly="readonly" style="padding: 17px 0px;">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-md-offset-3 mt-50 mb-10">
                                    <div class="col-md-9">
                                        <button type="submit" class="btn bg-blue btn-block"
                                            id="btnSearchLead">Search</button>
                                    </div>
