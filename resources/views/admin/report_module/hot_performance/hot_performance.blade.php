...
@section('content')
    ...
    <section class="content-header">
        <h1>Sales HoT Performance </h1>

        <ol class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Report Module</a></li>
            <li class="active">Sales HoT Performance </li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12" id="search_result_con">
                @include("admin.report_module.hot_performance.hot_performance_result")
            </div>
        </div>
    </section>
    <!-- /.content -->
