...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Brokerage & SFS</li>
        </ol>
    </section>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" style="width: 100%;" aria-hidden="true"
                                            ...
                                            <option value="2">Brokerage (Sales)</option>
                                            <option value="11">Brokerage (Rent Sales)</option>
                                            <option value="7">Brokerage (Rent Inventory)</option>
                                            <option value="9">Brokerage (Sales Inventory)</option>
                                            <option value="4">SFS Interiors(Internal)</option>
                                            <option value="10">SFS Interiors(External)</option>
                                            <option value="5">SFS (Building Design Product)</option>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12" id="search_result_con">
                @include("admin.report_module.sfs.sfs_result")
            </div>
        </div>
    </section>
    <!-- /.content -->
