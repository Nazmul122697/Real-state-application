            ...
            <tbody>
                ...
                @if (!empty($tl_wise_mem_arr))
                    @foreach ($tl_wise_mem_arr as $member => $value)
                        ...
                        @foreach ($value as $key => $row)
                            ...
                            <tr style="border-bottom:1px solid black;background-color: {{ $rand }};">
                                ...
                                <td class="text-center">
                                    {{ isset($target_mm[$member_name[0]]) && !empty($target_mm[$member_name[0]]) ? number_format($target_mm[$member_name[0]], 2) : 0 }}
                                </td>
                                <td class="text-center">
                                ...
                                <td class="text-center">
                                    {{ isset($target_ytd[$member_name[0]]) && !empty($target_ytd[$member_name[0]]) ? number_format($target_ytd[$member_name[0]], 2) : 0 }}
                                </td>
                    ...
                    <tr>
                        ...
                        <td  class="text-center">{{ isset($resize_arr['target_month']) ? $resize_arr['target_month'] : 0 }}</td>
                        <td  class="text-center">{{ isset($resize_arr['total_sale']) ? $resize_arr['total_sale'] : 0 }}</td>

                        <td  class="text-center">{{ isset($resize_arr['sale_value']) ? $resize_arr['sale_value'] : 0 }}</td>
                        <td  class="text-center">{{ isset($resize_arr['cancel_qty']) ? $resize_arr['cancel_qty'] : 0 }}</td>
                        <td  class="text-center">{{ isset($resize_arr['cancel_sale']) ? $resize_arr['cancel_sale'] : 0 }}</td>
                        @php
                        ...
                        @endphp
                        <td  class="text-center">{{ $resultant_value }} %</td>
                        <td  class="text-center">{{ number_format($result, 2) }}</td>
                        <td  class="text-center">{{ isset($resize_arr['target_ytd']) ? $resize_arr['target_ytd'] : 0 }}</td>
                        <td  class="text-center">{{ isset($resize_arr['t_total_sale']) ? $resize_arr['t_total_sale'] : 0 }}</td>
                        <td  class="text-center">{{ isset($resize_arr['t_sale_value']) ? $resize_arr['t_sale_value'] : 0 }}</td>
                        <td  class="text-center">{{ isset($resize_arr['t_cancel_qty']) ? $resize_arr['t_cancel_qty'] : 0 }}</td>
                        <td  class="text-center">{{ isset($resize_arr['t_cancel_sale']) ? $resize_arr['t_cancel_sale'] : 0 }}</td>
