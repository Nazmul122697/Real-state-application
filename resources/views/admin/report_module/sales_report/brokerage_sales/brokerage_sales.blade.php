...
@section('content')
    ...
    <section class="content-header">
        <h1>Brokerage Sales</h1>

        <ol class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Report Module</a></li>
            <li class="active">Brokerage Sales</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12" id="search_result_con">
                @include("admin.report_module.sales_report.brokerage_sales.brokerage_sales_result")
            </div>
        </div>
    </section>
    <!-- /.content -->
            ...
            $(document).on("click", "#btnSearchReport", function(e) {
                ...
                if (report_type == "") {
                    ...
                    $.ajax({
                        ...
                        url: 'brokerage_sales_report_result',
                        type: 'post',
                        beforeSend: function() {
                            $.blockUI({
