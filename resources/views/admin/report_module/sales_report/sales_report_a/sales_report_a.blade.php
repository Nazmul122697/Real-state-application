...
@section('content')
    ...
    <section class="content-header">
        <h1>Sales Report Bti</h1>

        <ol class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Report Module</a></li>
            <li class="active">Sales Report Bti</li>
        </ol>
    </section>
                            ...
                            <div class="form-row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" style="width: 100%;" aria-hidden="true"
                                            id="project_cate" name="project_cate">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="target_year" class="form-control" value="{{  date('Y') }}">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12" id="search_result_con">
                @include("admin.report_module.sales_report.sales_report_a.sales_report_a_result")
            </div>
        </div>
    </section>
    <!-- /.content -->
    ...
    <script>
        $(function() {
            ...
            $(document).on("click", "#btnSearchReport", function(e) {
                e.preventDefault();
                var report_type = $("#project_cate").val();
