                            ...
                            <div class="form-row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="cluster_head">Lead Type </label>
                                        <select class="form-control select2" style="width: 100%;" aria-hidden="true"
                                            id="report_type" name="report_type">
                                            <option value="">Select</option>
                                            <option value="3">BD Land</option>
                                            <option value="2">Brokage (Sales)</option>
                                            <option value="6">Brokage (Rent) </option>
                                            <option value="7">Brokage (Inventory) </option>
                                            <option value="4">SFS (Interiors)</option>
                                            <option value="5">SFS (Commercial)</option>
                                            <option value="8">Hollow Block</option>
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <select class="form-control select2" style="width: 100%;" aria-hidden="true"
                                            ...
                                            @if (!empty($cluster_head))
                                                @foreach ($cluster_head as $value)
                                                    <option value="{{ $value->user_pk_no }}">{{ $value->user_fullname }}
                                                    </option>
                                                @endforeach
                                            @endif
                                        </select>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="cluster_head">Year </label>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select name="target_month" id="target_month" class="form-control select2">
                                            ...
                                            <option <?php if (date('m')=='8' ) { echo 'selected' ; } ?> value="8">Augest</option>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12" id="search_result_con">
                @include("admin.report_module.sales_report.sales_report_result")
            </div>
        </div>
    </section>
    <!-- /.content -->
