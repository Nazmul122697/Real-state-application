...
@section('content')
    ...
    <section class="content-header">
        <h1>Brokerage Inventory</h1>

        <ol class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Report Module</a></li>
            <li class="active">Brokerage Inventory</li>
        </ol>
    </section>
                        ...
                        <div class="box-body">
                            <div class="form-row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="cluster_head">Year </label>
                                        <input type="text" value="{{ date('Y') }}" class="form-control" name="target_year">
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12" id="search_result_con">
                @include("admin.report_module.sales_report.brokerage_inventory.brokerage_inventory_report_result")
            </div>
        </div>
    </section>
    <!-- /.content -->
            ...
            $(document).on("click", "#btnSearchReport", function(e) {
                ...
                if (report_type == "") {
                    ...
                    $.ajax({
                        ...
                        url: 'brokerage_inventory_report_result',
                        type: 'post',
                        beforeSend: function() {
                            $.blockUI({
