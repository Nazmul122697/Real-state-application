        ...
        <table id="tbl_search_result" class="table table-bordered table-striped table-hover">
            <thead style="background-color:#5f5fd4;color:white">
                ...
                <tr>
                    ...
                    <th class="text-center" rowspan="2">TL</th>
                    ...
                    <th class="text-center" colspan="3" style="background-color:#a97e2f;color:white">Year to Date
                    </th>
                </tr>
                <tr>
                    <th> Lead</th>
                    <th>Target</th>
                    <th>Achi.</th>
                    <th style="background-color:#a97e2f;color:white"> Lead</th>
                    <th style="background-color:#a97e2f;color:white">Target</th>
