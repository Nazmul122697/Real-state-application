...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Source WIse K</a></li>
            <li class="active">Source WIse K</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12" id="search_result_con">
                @include("admin.report_module.source_wise_k.source_wise_k_result")
            </div>
        </div>
    </section>
    <!-- /.content -->
