...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">ACD Report</a></li>
            <li class="active">ACD Report</li>
        </ol>
    </section>
                            ...
                            <div class="form-row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="cluster_head">Report Type </label>
                                        <select name="report_type" id="report_type" class="form-control select2">
                                            <option value="">Select </option>
                                            <option value="1">K Report </option>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12" id="search_result_con">
                @include("admin.report_module.acd_report.acd_report_result")
            </div>
        </div>
    </section>
    <!-- /.content -->
