                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select name="project_category" id="project_category" class="form-control select2">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="target_year"
                                            value="{{ date('Y') }}">
                                    </div>
                                </div>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12" id="search_result_con">
                @include("admin.report_module.project_wise_report.project_wise_report_result")
            </div>
        </div>
    </section>
    <!-- /.content -->
            ...
            $(document).on("click", "#btnSearchReport", function(e) {
                ...
                if (report_type == "") {
                    ...
                    $.ajax({
                        ...
                        url: 'project_wise_report_result',
                        type: 'post',
                        beforeSend: function() {
                            $.blockUI({
                                message: '<i class="icon-spinner4 spinner"></i>',
