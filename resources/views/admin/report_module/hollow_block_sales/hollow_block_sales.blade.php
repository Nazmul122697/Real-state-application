...
@section('content')
    ...
    <section class="content-header">
        <h1>Hollow Block Sales</h1>

        <ol class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Report Module</a></li>
            <li class="active">Hollow Block Sales</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12" id="search_result_con">
                @include("admin.report_module.hollow_block_sales.hollow_block_sales_result")
            </div>
        </div>
    </section>
    <!-- /.content -->
    ...
    <script>
        $(function() {
            ...
            $(document).on("click", "#btnSearchReport", function(e) {
                e.preventDefault();
                var report_type = $("#project_category").val();
