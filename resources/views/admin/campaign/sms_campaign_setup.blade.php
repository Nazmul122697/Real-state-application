...
@section('content')
    ...
    <section class="content-header">
        <h1>SMS Campaign Setup</h1>

        <ol class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Campaign</a></li>
            <li class="active">SMS Campaign Setup</li>
        </ol>
    </section>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="cmbCategory[]" style="width: 100%;" aria-hidden="true" multiple="multiple">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="cmbArea[]" style="width: 100%;" aria-hidden="true" multiple="multiple">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="cmbProjectName[]" style="width: 100%;" aria-hidden="true" multiple="multiple">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 select2-hidden-accessible" style="width: 100%;"
                                                aria-hidden="true" name="cmb_stage[]" multiple="multiple">
                                            @php
                                                $stages = [1,3,4,5,6,7];
                                            @endphp
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <input type="hidden" name="hdn_email_campaign_name" id="hdn_email_campaign_name" value="">
                                <input type="hidden" name="hdn_sms_campaign_name" id="hdn_sms_campaign_name" value="">
        ...
        $(function () {
            ...
            $(document).on("click", "#btnSearchLead", function(e){
                ...
                $.ajax({
                    ...
                    url: 'search_result_for_sms_campaign',
                    type: 'post',
                    beforeSend:function(){
                        $.blockUI({
            ...
            $(document).on("click", "#btnExportLeads", function(e){
              /*  $('#frmSearch').submit()*/
                var email_campaign_name = $("#email_campaign_name").val();
                if ($("#email_campaign_name").val() == '') {
                    alert("Name your email campaign please");
                    return $("#email_campaign_name").focus();
                }

                if ($("#sms_campaign_name").val() == '') {
                    alert("Name your SMS campaign please");
                    return $("#sms_campaign_name").focus();
                }
                var sms_campaign_name = $("#sms_campaign_name").val();
                $("#hdn_sms_campaign_name").val(sms_campaign_name);
                $("#hdn_email_campaign_name").val(email_campaign_name);
