                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <span class="description-percentage {{ $caret_class }}">
                                <i class="fa fa-caret-{{ $caret }}"></i>
                                <strong>{{ number_format($achv, 2, '.', '') }}</strong>
                            </span>
                        </td>
                        <td class="text-center">
                            <span title="View Chart" class="view-chart-avt" data-title="KPI :: AVT"
                                data-action="{{ route('performance_chart_data', ['user_id' => $row->user_pk_no, 'type' => 'avt']) }}"
                                style="cursor: pointer;"><i class="ion ion-stats-bars"></i></span>
                        </td>
                    </tr>
                @endif
            @endforeach
