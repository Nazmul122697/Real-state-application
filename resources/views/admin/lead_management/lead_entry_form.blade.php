...
@endphp
<form id="frmLead"
    action="{{ !isset($lead_data) ? route('lead.store') : route('lead.update', $lead_data->lead_pk_no) }}"
            ...
            <div class="row">
                            ...
                            <select name="lead_type" class="form-control select2" id="business_unit">
                                ...
                                @if (!empty($lead_type))
                                    @foreach ($lead_type as $key => $type)
                                        @if ($ses_lead_type != '0' && $ses_super_admin != 1 && $group_id != '73' && $group_id != '74' && $group_id != '75' && $group_id != '76' && $group_id != '447' && $group_id != '203')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control required capitalize-text" id="customer_last_name"
                                    name="customer_last_name" value="" title="" placeholder="Customer Last Name" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control email-only" id="customer_email" name="customer_email"
                            value="" title="Customer Email" placeholder="e.g. username@bti.com" />
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="txt_organization" name="txt_organization" value=""
    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            <div class="form-row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <input type="text" class="form-control" id="txt_present_block_no" name="txt_present_block_no"
                            value="" title="" placeholder="Block No">
                    </div>
                </div>

                <div class="col-md-2">
                    <div class="form-group">
                        <input type="text" class="form-control" id="txt_present_plot_no" name="txt_present_plot_no"
                            value="" title="" placeholder="Plot No">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <input type="text" class="form-control" id="txt_present_sector_no" name="txt_present_sector_no"
                            value="" title="" placeholder="Sector No">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <input type="text" class="form-control" id="txt_details_no" name="txt_details_no" value=""
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control select2" required id="cmb_area" name="cmb_area" style="width: 100%;"
                            aria-hidden="true">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control select2" id="cmb_category" name="cmb_category"
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control select2" id="cmb_project_name" name="cmb_project_name"
                            data-action="{{ route('load_project_size') }}" style="width: 100%;" aria-hidden="true">
                            <option value="0" selected>Select</option>
                            @foreach ($project_name as $project)
                            <option value="{{$project->lookup_pk_no}}">{{$project->lookup_name}}</option>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Size<span class="text-danger"></span></label>
                        <select class="form-control select2" id="cmb_size" name="cmb_size" style="width: 100%;"
                            aria-hidden="true">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Number of Bed Rooms<span class="text-danger"></span></label>
                        <input type="text" class="form-control" id="bed_number" name="bed_number" value="" placeholder="Number of Bed Rooms">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Budget<span class="text-danger"></span></label>
                        <input type="text" class="form-control" id="budget_range" name="budget_range" value="" placeholder="Budget">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control keep_me" id="txt_source_title" name="txt_source_title"
                            value="{{ Session::get('user.ses_role_name') }}" title="Source Title" readonly="readonly"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control keep_me" id="txt_source_name" name="txt_source_name"
                            value="{{ Session::get('user.ses_full_name') }}" title="Source Name" readonly="readonly"
                            placeholder="Source Name" />
                        <input class="keep_me" type="hidden" name="hdn_source_id" id="ses_user_pk_no" value="{{ Session::get('user.ses_user_pk_no') }}" readonly="readonly" />
                    </div>
                </div>

                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="txt_source_name">Sub Source Name<span class="text-danger">
                                *</span></label>
                            <select name="sub_source_name" class="form-control required select2" id="sub_source_name" required >
                                <option value="">Select Sub Source</option>
                                @foreach ($sub_source as $sub)
                                <option value="{{$sub->lookup_name}}">{{$sub->lookup_name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="txt_source_name">Gift Source</label>
                            <select name="gift_source_name" class="form-control select2" id="gift_source_name" >
    ...
    @if ($group_id != 73)
                ...
                <div class="box-header with-border">
                    <label class="" style="cursor: pointer;">
                        <div class="iradio_flat-green" aria-checked="false" aria-disabled="false"
                            ...
                            <input type="radio" id="src_sac" value="DM" name="src_detail" class="flat-red"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label style="cursor:pointer;">
                                        <div class="iradio_flat-green" aria-checked="false" aria-disabled="false"
                                            style="position: relative; margin-right:10px; margin-bottom:6px;">
                                            <input type="radio" id="chk_digital_mark" value="{{ $key }}"
                                                name="chk_digital_mark[]" class="flat-red"
                                                style="position: absolute; opacity: 0;">
                                            <ins class="iCheck-helper"
                                                style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control required" id="txt_emp_id" name="txt_emp_id"
                                    value="" title="Emp ID" placeholder="Employee ID" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="txt_emp_name">Name<span class="text-danger"> *</span></label>
                                <input type="text" class="form-control required" id="txt_emp_name" name="txt_emp_name"
                                    value="" title="Name" placeholder="Employee Name" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="txt_emp_position">Position<span class="text-danger"> *</span></label>
                                <input type="text" class="form-control required" id="txt_emp_position"
                                    name="txt_emp_position" value="" title="Employee Position" placeholder="Position" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="txt_contract_no">Contact Number<span class="text-danger"> *</span></label>
                                <input type="text" class="form-control required" id="txt_contract_no"
                                    name="txt_contract_no" value="" title="Employee Contact Number"
            ...
            <div class="box" style="border-color:#ff851b;">
                <div class="box-header with-border">
                    <label class="" style="cursor: pointer;">
                        <div class="iradio_flat-green" aria-checked="false" aria-disabled="false"
                            style="position: relative; margin-right:10px; margin-bottom:6px;">
                            <input type="radio" id="src_sac" value="SAC" name="src_detail" class="flat-red"
                                style="position: absolute; opacity: 0;">
                            <ins class="iCheck-helper"
                                style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
                        </div>
                ...
                <div class="box-body">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="txt_src_name" name="txt_sac_name" value=""
                                title="Source Name" placeholder="Name" />
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="txt_src_note">Note</label>
                            <textarea class="form-control" rows="5" id="txt_src_note" name="txt_sac_note" title="Note"
        ...
        @if ($group_id == 76)
            <div class="box box-info">
                <div class="box-header with-border">
                    <label class="" style="cursor: pointer;">
                        <span style="font-size:18px; margin-top:-5px;">Hotline <small
                                style="font-weight: normal !important;">(Select any one option from the following
                                Dropdown Items)</small></span>
                    </label>
                </div>
                <div class="box-body">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Hotline</label>
                            <select class="form-control select2 hotline_dropdown" name="hotline[]" style="width: 100%;"
                                aria-hidden="true">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control hotline_text" id="hotline" name="hotline[]" value=""
                                title="Others" placeholder="Others" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control hotline_text" id="hotline" name="hotline[]" value=""
                                title="Sales Event" placeholder="Sales Event" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control hotline_text" id="hotline" name="hotline[]" value=""
                                title="Customer Engagement" placeholder="Customer Engagement" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control hotline_text" id="hotline" name="hotline[]" value=""
                                title="Fair" placeholder="Input Fair Name" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" id="txt_cust_dob" name="txt_cust_dob"
                                    value="<?php echo date('d-m-Y'); ?>" title="" readonly="readonly" placeholder="" />
                            </div>

                            <div class="form-group">
                                <label for="wife_name">Wife Name</label>
                                <input type="text" class="form-control" id="txt_wife_name" name="txt_wife_name" value=""
                                    title="Source Title" placeholder="Wife Name" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" id="txt_marriage_anniversary"
                                    name="txt_marriage_anniversary" value="<?php echo date('d-m-Y'); ?>" title=""
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" id="txt_child_dob_1"
                                    name="txt_child_dob_1" value="<?php echo date('d-m-Y'); ?>" title="" readonly="readonly"
                                    placeholder="" />
                            </div>

                            <div class="form-group">
                                <input type="text" class="form-control datepicker" id="txt_child_dob_2"
                                    name="txt_child_dob_2" value="<?php echo date('d-m-Y'); ?>" title="" readonly="readonly"
                                    placeholder="" />
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control datepicker" id="txt_child_dob_3"
                                    name="txt_child_dob_3" value="<?php echo date('d-m-Y'); ?>" title="" readonly="readonly"
                                    placeholder="" />
                            </div>
                        </div>
                        {{-- @if ($ses_super_admin == 1 || $group_id == '440' || $ses_lead_type == 2 || $ses_lead_type == 11 || $ses_lead_type == 7 || $ses_lead_type == 9 || $group_id != '73' || $group_id != '74' || $group_id != '75' || $group_id != '76' || $group_id != '447' || $group_id != '203')
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="marriage_anniversary">Bed Count</label>
                                    <input type="text" class="form-control" id="bed_count" name="bed_count" value=""
                                        title="" placeholder="Bed Count" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="marriage_anniversary">Budget/Price Range</label>
                                    <input type="text" class="form-control" id="budget_range" name="budget_range"
                                        value="" title="" placeholder="Budget/Price Range" />
                                </div>
                            </div>
                        @endif --}}
                    </div>
