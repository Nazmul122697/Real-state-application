            ...
            if(confirm("Are You Sure?"))
            {
                ...
                $(work_list_rows).each(function () {
                    ...
                    if ($(this).find("input[type=checkbox]").is(':checked')) {
                        ...
                        $.ajax({
                            data: {lead_pk_no: lead_pk_no, cmbTransferTo: cmbTransferTo, lead_name: lead_name, category:category,cmb_category:cmb_category,cmb_area:cmb_area,cmb_project_name:cmb_project_name,cmb_size:cmb_size,agent:agent},
            ...
            if(confirm("Are you sure?"))
            {
                ...
                $(work_list_rows).each(function () {
                    ...
                    if ($(this).find("input[type=checkbox]").is(':checked')) {
                        ...
                        $.ajax({
                            data: {transfer_id: transfer_id,lead_id:lead_id,to_agent:to_agent},
