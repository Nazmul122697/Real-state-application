<form id="frmUser" action="{{ !isset($flat_data)?route('store_flat_setup') : route('update_flat_setup',$flat_data->flatlist_pk_no) }}" method="{{ !isset($flat_data)?'post' : 'post' }}">
                    ...
                    <div class="col-md-12">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control required" id="flat_name" name="flat_name" title="Flat Name" placeholder="Flat Name" tabindex="" required="required" value="{{ isset($flat_data)? $flat_data->flat_name:'' }}" />
                            </div>
                            <div class="form-group">
    ...
    <div class="modal-footer">
        ...
        <button type="submit"
        class="btn bg-purple btn-sm btnSaveUpdate" data-response-action="{{ route('load_project_wise_flat_list') }}" >{{ isset($flat_data)? 'Update':'Create' }}</button>
        <span class="msg"></span>
    </div>
</form>