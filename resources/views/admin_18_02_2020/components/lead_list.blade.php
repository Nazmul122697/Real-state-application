						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">
									<span class="btn bg-info btn-xs lead-view" title="Lead Details" data-title="View Lead Details" data-id="{{ $row->lead_pk_no }}" data-action="{{ route('lead_view',$row->lead_pk_no) }}"><i class="fa fa-eye"></i></span>
								</td>
							</tr>
							@endforeach
							@else
		...
		<div class="col-sm-2">
			...
			<div class="form-group">
				<label class="pull-left" style="cursor: pointer;">
					...
					<span style="font-size:13px; margin-top:-5px;">Agent&nbsp;</span>
				</label>
