...
<div class="head_action" style="background-color: #ECF0F5; text-align: right; border: 1px solid #ccc; padding: 3px;">
    ...
    <label class="">
        &nbsp Yes &nbsp
        <div class="iradio_flat-green {{ ($ses_auto_dist==1)?'checked':'' }}" aria-checked="false" aria-disabled="false" style="position: relative; margin-right:10px; margin-bottom:6px;">
            <input type="radio" value="1" name="auto_distribute"  class="auto_distribute flat-red"  style="position: absolute; opacity: 0;" {{ ($ses_auto_dist==1)?'checked':'' }} >
    ...
    <label class="">
        &nbsp No &nbsp
        <div class="iradio_flat-green {{ ($ses_auto_dist==0)?'checked':'' }}" aria-checked="false" aria-disabled="false" style="position: relative; margin-right:10px; margin-bottom:6px;">
            <input type="radio" value="0" name="auto_distribute" class="auto_distribute flat-red"  style="position: absolute; opacity: 0;" {{ ($ses_auto_dist==0)?'checked':'' }}>
            <ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
        </div>
    </label>
