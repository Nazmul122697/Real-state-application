<div class="head_action" style="background-color: #ECF0F5; text-align: right; border: 1px solid #ccc; padding: 3px;">
	...
	<label class="">
		...
		<div class="iradio_flat-green" aria-checked="false" aria-disabled="false" style="position: relative; margin-right:10px; margin-bottom:6px;">
			<input type="radio" value="1" name="can_bypass" class="can_bypass flat-red"  style="position: absolute; opacity: 0;">
	...
	<label class="">
		&nbsp No &nbsp
		<div class="iradio_flat-green" aria-checked="false" aria-disabled="false" style="position: relative; margin-right:10px; margin-bottom:6px;">
			<input type="radio" value="0" name="can_bypass" class="can_bypass flat-red"  style="position: absolute; opacity: 0;">
			<ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
		</div>
	</label>
	...
	<div class="form-group" style="display: inline-block; margin-bottom: 0px !important;">
		<input type="text" class="form-control datepicker" id="bypass_date" name="bypass_date" value="<?php echo date('d-m-Y'); ?>" title="" readonly="readonly" placeholder="" style="display: inline-block;"/>
	</div>
</div><br clear="all" />
