			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" class="form-control datepicker required" id="txt_lead_date" name="txt_lead_date" placeholder="Select Date" title="" readonly="" placeholder="Entry Date"/>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-xs-8">
									<input type="text" class="form-control number-only required check_phone_no" id="customer_phone1" name="customer_phone1" maxlength="10" placeholder="Phone Number 1"/>
								</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-xs-8">
									<input type="text" class="form-control number-only check_phone_no" id="customer_phone2" name="customer_phone2" maxlength="10" placeholder="Phone Number 2"/>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="col-md-3">
				<div class="form-group">
					<label style="cursor:pointer;">
						<div class="iradio_flat-green" aria-checked="false" aria-disabled="false" style="position: relative; margin-right:10px; margin-bottom:6px;">
							<input type="radio" id="chk_digital_mark" value="{{ $key }}" name="chk_digital_mark[]" class="flat-red"  style="position: absolute; opacity: 0;">
							<ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control datepicker" id="txt_cust_dob" name="txt_cust_dob" placeholder="Select Date" title="" readonly="readonly" placeholder=""/>
							</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control datepicker" id="txt_marriage_anniversary" name="txt_marriage_anniversary" placeholder="Select Date" title="" readonly="readonly" placeholder=""/>
							</div>

							<div class="form-group">
								<label for="wife_dob">Wife DOB</label>
								<input type="text" class="form-control datepicker" id="txt_wife_dob" name="txt_wife_dob" placeholder="Select Date" title="" readonly="readonly" placeholder=""/>
							</div>
						</div>
						<br clear="all" /><br />
						<div class="col-md-6">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control datepicker" id="txt_child_dob_1" name="txt_child_dob_1" placeholder="Select Date" title="" readonly="readonly" placeholder=""/>
							</div>

							<div class="form-group">
								<input type="text" class="form-control datepicker" id="txt_child_dob_2" name="txt_child_dob_2" placeholder="Select Date" title="" readonly="readonly" placeholder=""/>
							</div>
							<div class="form-group">
								<input type="text" class="form-control datepicker" id="txt_child_dob_3" name="txt_child_dob_3" placeholder="Select Date" title="" readonly="readonly" placeholder=""/>
							</div>
						</div>
					</div>
				</div>
